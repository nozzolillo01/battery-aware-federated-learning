...
class FlowerClient(NumPyClient):
    ...
    def __init__(self, net, trainloader, valloader, local_epochs, lr, context):
        """Initialize client."""
    ...
    def fit(self, parameters, config):
        ...
        loss, accuracy = train(self.net, self.trainloader, self.local_epochs, self.lr, device=self.device)
